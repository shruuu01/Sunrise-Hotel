...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>022-444-1818</li>	
					<li class="s-bar">
						<div class="search">
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SUNRISE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SUNRISE</h3> 
						   <p class="about-para-w3ls">Discover classic luxury in SUNRISE Hotels with mindful experiences and inspiring spaces to improve your well-being and enrich your mind, body and soul.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Experience Luxury With SUNRISE!!! </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Stay With Us & Pay Us Later In Various Modes Of Payments .</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>With Top-Notched Quality Of Chefs & Various Variety OF Cusine.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>022-444-1818</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong>175, Royal Treat Building, Shivaji Road, Panvel City, Navi Mumbai - 410206 </p>
